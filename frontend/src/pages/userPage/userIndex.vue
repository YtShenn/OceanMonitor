    ...
    <div class="main">
      <div class="side-bar" style="z-index:10">
        <ul class="channel-list">
          <li :class="{ 'active-channel': activeChannel === 'datahub' }">
            <a class="link-wrapper" @click="toData">
              <House style="width: 1em; height: 1em; margin-right: 8px" /><span class="channel">数据查看</span>
            </a>
          </li>
          <li :class="{ 'active-channel': activeChannel === 'uanalysis' }">
          ...
          <ul v-if="activeChannel === 'uanalysis' || activeChannel === 'charts' || activeChannel === 'map'" class="sub-menu">
...
<script setup>
  ...
  const activeChannel = ref('datahub');
  ...
  const toData = () => {
    router.push({ name: 'datahub' });
    activeChannel.value = 'datahub';
  };
  const toAnalysis = () => {
    // console.log("toAnalysis");
    // router.push({ name: 'uanalysis' });
    activeChannel.value = 'uanalysis';
  };
  const toCharts = () => {
      // console.log("toAnalysis");
      router.push({ name: 'uanalysis' });
